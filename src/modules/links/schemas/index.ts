...
const CREATE_SHARABLE_LINK_SCHEMA = z.object({
	linkIds: z.string().uuid().array().describe('Array of link IDs to be shared'),
})

type CREATE_SHARABLE_LINK = z.infer<typeof CREATE_SHARABLE_LINK_SCHEMA>
