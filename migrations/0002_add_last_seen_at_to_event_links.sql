ALTER TABLE "event_to_academic_group" ADD COLUMN "last_seen_at" bigint NOT NULL DEFAULT 0;--> statement-breakpoint
ALTER TABLE "event_to_teacher" ADD COLUMN "last_seen_at" bigint NOT NULL DEFAULT 0;--> statement-breakpoint
